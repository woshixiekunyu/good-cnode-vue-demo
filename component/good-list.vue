		...
		directives:{
			...
			getCollect(el){
				$(el).on('click',function(){
					...
					.children('.goodList').children('ul').children('li').eq(idxNum).css('backgroundColor','yellow')
				})
			...
			removeCollect(el){
				$(el).on('click',function(){
					...
					$(this).parent().parent().parent().prev().prev()
					.children('.goodList').children('ul').children('li').eq(idxNum).css('backgroundColor','#fff')
				})
